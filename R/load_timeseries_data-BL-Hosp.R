...
#new_date_Chile <- max(data_Chile_Feb$date)
...
fix_r0_tt <- as.numeric(new_date_bl - start_date + 1) #as.Date("2020-03-18") as.numeric(Chile_travel_restrictions - start_date + 1) # set noise = 0 after this period of fitting
